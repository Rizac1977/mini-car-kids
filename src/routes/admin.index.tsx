    ...
    <div className="min-h-screen bg-background">
      <aside className="hidden lg:flex fixed inset-y-0 left-0 w-64 flex-col bg-sidebar text-sidebar-foreground">
        ...
        <div className="p-3 border-t border-sidebar-border">
          <Link to="/login" className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm hover:bg-sidebar-accent">
            <LogOut className="h-4 w-4" /> Sair
          </Link>
        </div>
      </aside>
      <div className="lg:pl-64">
        <header className="sticky top-0 z-30 bg-background/90 backdrop-blur border-b px-4 py-3 lg:px-8 lg:py-4 flex items-center justify-between">
          <div>
          ...
          <Link
            to="/app"
            className="text-xs text-muted-foreground hover:text-foreground hidden lg:inline"
          >
            Ir para app do dono →
          </Link>
        </header>
